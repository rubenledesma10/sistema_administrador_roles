...
public class LoginInicial extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        /*tenemos que asegurarnos que el usuario y la contraseña existan, por eso vamos a hacer que nos devuelva un true
        si son correctas o si estan mal y que nos devuelva un mensaje*/
        if (usr!=null) {
            /*creamos una variable rol traigo el rol primero, el objeto rol y despues de ese objeto traigo el nombre del rol
            y comparo cual de los dos es*/
            String rol = usr.getUnRol().getNombreRol();
            
            //que nos valide y nos devuelva que rol tiene
            if(rol.equals("admin")){
                //en caso de que sea admin llamamos a la pantalla de admin
                PrincipalAdmin pAdmin = new PrincipalAdmin(control, usr); //le pasamos la controladora para seguir manejando la misma instancia y no estar creando tantas instancias. Y le paso USR para que me muestre el nombre en la pantalla
                pAdmin.setVisible(true);
                pAdmin.setLocationRelativeTo(null);
                this.dispose();
            }
            if (rol.equals("user")){
                //en caso de que sea user llamamos a la pantalla de user
            ...
            //que muestre el mensaje en caso de que sea falso
            txtMensaje.setText("Usuario y/o contraseña incorrectas");
        }
